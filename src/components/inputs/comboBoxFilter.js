...
function ComboBoxFilter(props) {
  ...
  return (
    ...
    <p class="form-floating text-[1.2rem] text-black font-normal">{props.children}:</p>
      <select value={selecionado} onChange={handleChange} className="w-[10rem] h-8 rounded bg-[F5F3F4] pl-2 text-[1rem] font-[300] text-[#555] form-control border border-1 border-slate-600">
