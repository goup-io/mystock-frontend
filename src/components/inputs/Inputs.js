...
function Input(props){
    return(
        <form class="relative">
            ...
            <input type={`${props.type}`} placeholder={`${props.placeholder}`} class="w-[32.8rem] h-[3.75rem] rounded-[3.125rem] bg-[F5F3F4] pl-16 text-[1.5625rem] font-[400] text-[#555] form-control border border-slate-600"
            ></input>
            {/* <div class="relative">
