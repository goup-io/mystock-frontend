...
function InputFilterDate(props) {
    ...
    return (
            ...
            <div className="w-full flex justify-around items-center text-center ">
                ...
                <input type={`${props.type}`} placeholder={`${props.placeholder}`} class="w-[7rem] h-[1.5rem] rounded bg-[F5F3F4] text-center text-[0.8rem] font-[400] text-[#555] border border-gray-700"
                ></input>
