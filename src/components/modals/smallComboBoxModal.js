...
function ComboBoxModal(props) {
  ...
  return (
    <div className="flex flex-col justify-start items-start">
      ...
      <select onChange={props.handleChange} className="w-[16rem] h-7 rounded bg-[F5F3F4] pl-2 text-[1rem] font-[300] text-[#555] form-control border border-1 border-slate-600">
