...
function LargeComboBoxModal(props) {
  ...
  return (
    ...
    <p className="form-floating text-lg text-black mb-2 font-normal">{props.children}:</p>
      <select onChange={props.handleChange} disabled={props.disabled} className="w-full h-7 rounded bg-[F5F3F4] pl-2 text-[0.8rem] font-[300] text-[#555] form-control border border-1 border-slate-600">
